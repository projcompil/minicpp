...
let rec _menhir_goto_nonempty_list_vinstruction_ : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.expression_str list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState131 ->
        ...
        let _v : (Ast.expression_str list) =     ( x :: xs ) in
        _menhir_goto_nonempty_list_vinstruction_ _menhir_env _menhir_stack _menhir_s _v
    | MenhirState126 ->
        let _menhir_stack = Obj.magic _menhir_stack in
...
and _menhir_goto_list_instruction_ : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.inst list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState49 ->
...
and _menhir_run127 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    ...
    | CHAINE _v ->
        ...
        let _menhir_stack = Obj.magic _menhir_stack in
        let x = _v in
        let _v : (Ast.expression_str) =              ( Estring x) in
...
and _menhir_goto_expr_str : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.expression_str) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = Obj.magic _menhir_stack in
    let _menhir_stack = Obj.magic _menhir_stack in
    let e = _v in
    let (_menhir_stack, _menhir_s) = _menhir_stack in
    let _v : (Ast.expression_str) =                                      ( e ) in
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_stack = Obj.magic _menhir_stack in
    assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
    let _tok = _menhir_env._menhir_token in
    ...
    | SEMICOLON ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let (_menhir_stack, _menhir_s, x) = _menhir_stack in
        let _v : (Ast.expression_str list) =     ( [ x ] ) in
        _menhir_goto_nonempty_list_vinstruction_ _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
        _menhir_env._menhir_shifted <- (-1);
...
and _menhir_goto_separated_nonempty_list_COMMA_expr_ : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.expression list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    match _menhir_s with
...
and _menhir_run78 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.expression) * Lexing.position * Lexing.position -> Lexing.position -> 'ttv_return =
...
and _menhir_run85 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.expression) * Lexing.position * Lexing.position -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _startpos ->
    let _menhir_stack = (_menhir_stack, _startpos) in
    let _tok = _menhir_discard _menhir_env in
    match _tok with
...
and _menhir_run91 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.expression) * Lexing.position * Lexing.position -> 'ttv_return =
...
and _menhir_run93 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.expression) * Lexing.position * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let _tok = _menhir_discard _menhir_env in
    match _tok with
    | DECR ->
...
and _menhir_run87 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.expression) * Lexing.position * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let _tok = _menhir_discard _menhir_env in
    match _tok with
    | DECR ->
...
and _menhir_run95 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.expression) * Lexing.position * Lexing.position -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _startpos ->
    let _menhir_stack = (_menhir_stack, _startpos) in
    let _tok = _menhir_discard _menhir_env in
    match _tok with
...
and _menhir_run97 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.expression) * Lexing.position * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let _tok = _menhir_discard _menhir_env in
    match _tok with
    | DECR ->
...
and _menhir_run99 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.expression) * Lexing.position * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let _tok = _menhir_discard _menhir_env in
    match _tok with
    | DECR ->
...
and _menhir_run101 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.expression) * Lexing.position * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let _tok = _menhir_discard _menhir_env in
    match _tok with
    | DECR ->
...
and _menhir_run103 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.expression) * Lexing.position * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let _tok = _menhir_discard _menhir_env in
    match _tok with
    | DECR ->
...
and _menhir_run105 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.expression) * Lexing.position * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let _tok = _menhir_discard _menhir_env in
    match _tok with
    | DECR ->
...
and _menhir_run89 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.expression) * Lexing.position * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let _tok = _menhir_discard _menhir_env in
    match _tok with
    | DECR ->
...
and _menhir_run111 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.expression) * Lexing.position * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let _tok = _menhir_discard _menhir_env in
    match _tok with
    | DECR ->
...
and _menhir_run107 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.expression) * Lexing.position * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let _tok = _menhir_discard _menhir_env in
    match _tok with
    | DECR ->
...
and _menhir_run71 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.expression) * Lexing.position * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    ...
    | IDENT _v ->
        ...
        let _v : (Ast.desc) =                               ( Esderef (x,y) ) in
...
and _menhir_run73 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.expression) * Lexing.position * Lexing.position -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _startpos ->
    let _menhir_stack = (_menhir_stack, _startpos) in
    let _tok = _menhir_discard _menhir_env in
    match _tok with
...
and _menhir_run80 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.expression) * Lexing.position * Lexing.position -> Lexing.position -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _startpos _endpos ->
    ...
    let _v : (Ast.desc) =                  ( Erincr x ) in
    _menhir_goto_dexpr _menhir_env _menhir_stack _menhir_s _v _startpos _endpos

and _menhir_run81 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.expression) * Lexing.position * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let _tok = _menhir_discard _menhir_env in
    match _tok with
    | IDENT _v ->
...
and _menhir_run83 : _menhir_env -> 'ttv_tail * _menhir_state * (Ast.expression) * Lexing.position * Lexing.position -> Lexing.position -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _startpos _endpos ->
    let _ = _menhir_discard _menhir_env in
    let _menhir_stack = Obj.magic _menhir_stack in
    let _startpos__2_ = _startpos in
    ...
    let _startpos = _startpos_x_ in
    let _endpos = _endpos__2_ in
    let _v : (Ast.desc) =                  ( Erdecr x ) in
    _menhir_goto_dexpr _menhir_env _menhir_stack _menhir_s _v _startpos _endpos

and _menhir_goto_loption_separated_nonempty_list_COMMA_expr__ : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.expression list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState73 ->
...
and _menhir_goto_dexpr : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.desc) -> Lexing.position -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v _startpos _endpos ->
    ...
    let _v : (Ast.expression) =             ( { desc = d ; loc = _startpos, _endpos } ) in
    ...
    | MenhirState111 ->
        ...
        | CHEVRON | COMMA | RPAR | SEMICOLON ->
            ...
            let _startpos = _startpos_x_ in
            let _endpos = _endpos_y_ in
            let _v : (Ast.desc) =                              ( Eassign (x,y) ) in
            _menhir_goto_dexpr _menhir_env _menhir_stack _menhir_s _v _startpos _endpos
        | _ ->
            assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
            _menhir_env._menhir_shifted <- (-1);
    ...
    | MenhirState53 ->
        ...
        | AND | ASSIGN | CHEVRON | COMMA | DIV | EQ | GE | GT | LE | LT | MINUS | MODULO | NEQ | OR | PLUS | RPAR | SEMICOLON | TIMES ->
            ...
            let _startpos = _startpos__1_ in
            let _endpos = _endpos_x_ in
            let _v : (Ast.desc) =                                ( Epointeur (x) ) in
            _menhir_goto_dexpr _menhir_env _menhir_stack _menhir_s _v _startpos _endpos
        | _ ->
            assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
            _menhir_env._menhir_shifted <- (-1);
    ...
    | MenhirState127 ->
        ...
        | CHEVRON | SEMICOLON ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let (_menhir_stack, _menhir_s, x, _startpos_x_, _endpos_x_) = _menhir_stack in
            let _v : (Ast.expression_str) =            ( Esexpr x ) in
            _menhir_goto_expr_str _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
            _menhir_env._menhir_shifted <- (-1);
    ...
    | MenhirState154 ->
        ...
        | SEMICOLON ->
            ...
            let _v : (Ast.inst) =                                                 ( Idecl (t,v,e) ) in
            _menhir_goto_instruction _menhir_env _menhir_stack _menhir_s _v
        | TIMES ->
            _menhir_run78 _menhir_env (Obj.magic _menhir_stack) _menhir_env._menhir_startp
        | _ ->
...
and _menhir_goto_qvar : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.qvariable) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
...
and _menhir_goto_instruction : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.inst) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState150 ->
    ...
    | MenhirState172 ->
        ...
        let _v : (Ast.inst) = (Ifelse (e,i,y) ) in
        _menhir_goto_instruction _menhir_env _menhir_stack _menhir_s _v
    | MenhirState124 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let (((((_menhir_stack, _menhir_s), _startpos__2_), _, e, _startpos_e_, _endpos_e_), _endpos__4_), _, i) = _menhir_stack in
        let _v : (Ast.inst) =                                                     ( While (e,i) ) in
        _menhir_goto_instruction _menhir_env _menhir_stack _menhir_s _v
...
and _menhir_run67 : _menhir_env -> 'ttv_tail -> _menhir_state -> Lexing.position -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _startpos _endpos ->
    ...
    let _startpos = _startpos__1_ in
    let _endpos = _endpos__1_ in
    let _v : (Ast.desc) =         ( Ebool false) in
    _menhir_goto_dexpr _menhir_env _menhir_stack _menhir_s _v _startpos _endpos
...
and _menhir_goto_separated_nonempty_list_COMMA_var_ : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.variable list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState40 ->
...
and _menhir_goto_qident : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.qidentifiant) -> Lexing.position -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v _startpos _endpos ->
    ...
    | MenhirState199 | MenhirState200 | MenhirState201 | MenhirState28 | MenhirState29 | MenhirState34 ->
        ...
        let _startpos_x_ = _startpos in
        let _endpos_x_ = _endpos in
        let _v : (Ast.qvariable) =              ( Qvar x ) in
        _menhir_goto_qvar _menhir_env _menhir_stack _menhir_s _v
...
and _menhir_reduce99 : _menhir_env -> 'ttv_tail * _menhir_state * (string) * Lexing.position * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let (_menhir_stack, _menhir_s, x, _startpos_x_, _endpos_x_) = _menhir_stack in
    let _v : (Ast.variable) =             ( Ident x) in
    _menhir_goto_var _menhir_env _menhir_stack _menhir_s _v
...
and _menhir_goto_fichier : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.file) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = Obj.magic _menhir_stack in
    let _menhir_stack = Obj.magic _menhir_stack in
    let _1 = _v in
...
and _menhir_goto_separated_nonempty_list_COMMA_TIDENT_ : _menhir_env -> 'ttv_tail -> _menhir_state -> (string list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState188 ->
        ...
        let _menhir_stack = Obj.magic _menhir_stack in
        let _v : (bool) =     ( true ) in
        _menhir_goto_boption_supers_ _menhir_env _menhir_stack _v
    | _ ->
        _menhir_fail ()
  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState25 ->
        ...
        | EOF ->
            ...
            let _menhir_stack = Obj.magic _menhir_stack in
            let ((_menhir_stack, _menhir_s), _, x) = _menhir_stack in
            let _v : (Ast.file) =                                  ( {bincludeios = true ; declarations =  x} ) in
    ...
    | MenhirState0 ->
        ...
        | EOF ->
            ...
            let _menhir_stack = Obj.magic _menhir_stack in
            let (_menhir_stack, _menhir_s, x) = _menhir_stack in
            let _v : (Ast.file) =                    ( {bincludeios = false ; declarations =  x }) in
            _menhir_goto_fichier _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
            _menhir_env._menhir_shifted <- (-1);
...
and _menhir_goto_typ : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.typedef) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
...
and _menhir_goto_boption_supers_ : _menhir_env -> 'ttv_tail -> (bool) -> 'ttv_return =
...
and _menhir_run189 : _menhir_env -> 'ttv_tail -> _menhir_state -> (string) -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v _startpos ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v, _startpos) in
    let _tok = _menhir_discard _menhir_env in
    match _tok with
...
and _menhir_run26 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    ...
    | IDENT _v ->
        ...
        let (_menhir_stack, _menhir_s) = _menhir_stack in
        let _v : (string) =                      ( Hashtbl.add (Lexer.table) z () ; z ) in
        let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
        let _menhir_stack = Obj.magic _menhir_stack in
        assert (Pervasives.(<>) _menhir_env._menhir_shifted (-1));
        let _tok = _menhir_env._menhir_token in
...
and fichier : (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (Ast.file) =
  fun lexer lexbuf ->
